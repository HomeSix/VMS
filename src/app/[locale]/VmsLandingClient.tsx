...
// Default to "en" so UI strings are always defined before a selection is made
...
export default function VmsLandingClient() {
    const router = useRouter();
    const [selected, setSelected] = useState<Locale | null>(null);

    // UI strings follow the selected locale, falling back to English
                ...
                <div className="bg-white border border-[#e0ddd8] overflow-hidden">
                    ...
                    <div className="px-10 py-10">
                        ...
                        >
                            <svg
                                viewBox="0 0 24 24"
                                className={cn("w-3 h-3 flex-shrink-0", selected ? "fill-white" : "fill-[#bbb]")}
                            >
                                <path d="M12.089 3.634A2 2 0 0 0 11 5.414L10.999 8H6a1 1 0 0 0-1 1v6l.007.117A1 1 0 0 0 6 16l4.999-.001l.001 2.587A2 2 0 0 0 14.414 20L21 13.414a2 2 0 0 0 0-2.828L14.414 4a2 2 0 0 0-2.18-.434zM3 8a1 1 0 0 1 .993.883L4 9v6a1 1 0 0 1-1.993.117L2 15V9a1 1 0 0 1 1-1" />							</svg>
